...
(function($){
	...
	$.jNotify = {
		defaults: {
			...
			LongTrip : 325,					// in pixel, length of the move effect when show and hide
			...
			switch (opts.VerticalPosition) {
				case 'top':
					...
					if(opts.autoHide)
						...
						$Div.css('pointer').click(function(e){
							$.jNotify._close();
						});
					break;
				case 'center':
	...
	jLoginjd = function(msg,options) {
		if($.jNotify._isReadable('jLoginjd'))
			$.jNotify.init(msg,options,'jLoginjd');
	};
})(jQuery);
