...
CREATE TABLE r_getcontent_j(
    ...
    shop_number CHAR(150)NOT NULL DEFAULT '',
    href CHAR(100) NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_word(
    ...
    sku CHAR(30) NOT NULL,
    price float(6,2) NOT NULL DEFAULT "0",
    shop_number CHAR(50) NOT NULL DEFAULT '',
    shop_type CHAR(100) NOT NULL DEFAULT '',
    market_time CHAR(30) NOT NULL,
...
CREATE TABLE r_getcontent_detail(
    ...
    price float(6,2) NOT NULL DEFAULT "0",
    shop_number CHAR(150)NOT NULL DEFAULT '',
    brand_list CHAR(150)NOT NULL,
    market_time CHAR(30)NOT NULL,
    shop_name CHAR(150)NOT NULL DEFAULT '',
    price_app FLOAT(6,2) NOT NULL DEFAULT '0',
    same_list CHAR(150)NOT NULL,
    belong_shop CHAR(150)NOT NULL,
    sales_info CHAR(150)NOT NULL DEFAULT '',
    preferential CHAR(150)NOT NULL DEFAULT '',
    belong_brand CHAR(150)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_shop_base1(
    ...
    time CHAR(30) NOT NULL,
    shop_name CHAR(100) NOT NULL DEFAULT '',
    sale_shop CHAR(100) NOT NULL DEFAULT '',
...
CREATE TABLE r_brand_search(
    ...
    shop_id CHAR(150)NOT NULL DEFAULT '',
    shop_name CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_trade2(
    ...
    show_goods CHAR(150)NOT NULL DEFAULT '',
    rise FLOAT(5,2) NOT NULL DEFAULT '0',
    show_rise CHAR(150)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_trade3(
    ...
    shop_sku CHAR(60)NOT NULL DEFAULT '',
    goods_strike CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_trade5(
    ...
    period CHAR(150)NOT NULL DEFAULT '',
    tty CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_trade6(
    ...
    uid INT(10) UNSIGNED NOT NULL,
    time CHAR(30) NOT NULL,
    uv CHAR(150)NOT NULL DEFAULT '',
    pro_uv CHAR(150)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_sister1(
    ...
    uid INT(10) UNSIGNED NOT NULL,
    time CHAR(30) NOT NULL,
    cate1 CHAR(150)NOT NULL DEFAULT '',
    cate2 CHAR(150)NOT NULL DEFAULT '',
    cate3 CHAR(150)NOT NULL DEFAULT '',
    period CHAR(150)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_hword1(
    ...
    uid INT(10) UNSIGNED NOT NULL,
    time CHAR(30) NOT NULL,
    h_words CHAR(150)NOT NULL DEFAULT '',
    ...
    cate3 CHAR(150)NOT NULL DEFAULT '',
    related_w CHAR(150)NOT NULL DEFAULT '',
    h_w_detail CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_hword2(
    ...
    cate3 CHAR(150)NOT NULL DEFAULT '',
    h_w_related CHAR(150)NOT NULL DEFAULT '',
    h_w_detail CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_brand_sister1(
    ...
    cate3 CHAR(150)NOT NULL DEFAULT '',
    period CHAR(150)NOT NULL DEFAULT '',
    client CHAR(150)NOT NULL DEFAULT '',
    banrd CHAR(150)NOT NULL DEFAULT '',
    banrd_id CHAR(150)NOT NULL DEFAULT '',
    h_index FLOAT(5,2) NOT NULL DEFAULT '0',
    a_index FLOAT(5,2) NOT NULL DEFAULT '0',
    detailed CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_brand_detail_2(
    ...
    banrd CHAR(150)NOT NULL DEFAULT '',
    h_index FLOAT(5,2) NOT NULL DEFAULT '0',
    cate_deep CHAR(150)NOT NULL DEFAULT '',
    cate CHAR(150)NOT NULL DEFAULT '',
    strike_pro FLOAT(5,2) NOT NULL DEFAULT '0'
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_brand_detail_3_1(
    ...
    shop_name CHAR(150)NOT NULL DEFAULT '',
    shop_id CHAR(150)NOT NULL DEFAULT '', 
    air_index CHAR(150)NOT NULL DEFAULT '',
    h_top CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_brand_detail_3_2(
    ...
    shop_name CHAR(150)NOT NULL DEFAULT '',
    shop_id CHAR(150)NOT NULL DEFAULT '',
    goods_name CHAR(150)NOT NULL DEFAULT '',
    sku CHAR(60)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_attr(
    ...
    period CHAR(150)NOT NULL DEFAULT '',
    client CHAR(150)NOT NULL DEFAULT '',
    attribute CHAR(150)NOT NULL DEFAULT '',
    project CHAR(150)NOT NULL DEFAULT '',
    strike_index FLOAT(5,2) NOT NULL DEFAULT '0',
    ...
    attribute_detail CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_attr_detail_2 (
    ...
    strike_index FLOAT(5,2) NOT NULL DEFAULT '0',
    p_strike_index FLOAT(5,2) NOT NULL DEFAULT '0',
    shop_n CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_src_key_1(
    ...
    sku CHAR(60)NOT NULL DEFAULT '',
    period CHAR(150)NOT NULL DEFAULT '',
    rate_src CHAR(150)NOT NULL DEFAULT '',
...
CREATE TABLE r_src_key_2(
    ...
    sku CHAR(60)NOT NULL DEFAULT '',
    period CHAR(150)NOT NULL DEFAULT '',
    h_s_key CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_mate_hw_1_1(
    ...
    c_rate FLOAT(5,2) NOT NULL DEFAULT '0',
    h_w_detail CHAR(150)NOT NULL DEFAULT '',
    h_w_n CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_mate_hw_1_2(
    ...
    cate3 CHAR(150)NOT NULL DEFAULT '',
    period CHAR(150)NOT NULL DEFAULT '',
    interfix_w CHAR(150)NOT NULL DEFAULT '',
    h_w_detail CHAR(150)NOT NULL DEFAULT '',
    h_w_n CHAR(150)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_mate_hw1_1(
    ...
    cate3 CHAR(150)NOT NULL DEFAULT '',
    period CHAR(150)NOT NULL DEFAULT '',
    goods_title CHAR(150)NOT NULL DEFAULT '',
    sku CHAR(60)NOT NULL DEFAULT '',
    h_w_name CHAR(150)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_client_run(
    ...
    goods_name CHAR(150)NOT NULL DEFAULT '',
    sku CHAR(60)NOT NULL DEFAULT '',
    under_shop CHAR(150)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_shop_general(
    ...
    ground_sku CHAR(60)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_shop_general_m_2(
    ...
    uid INT(10) UNSIGNED NOT NULL,
    time CHAR(30) NOT NULL,
    time_part CHAR(150)NOT NULL DEFAULT '',
    look_num INT(10) NOT NULL DEFAULT '0',
    v_num INT(10) NOT NULL DEFAULT '0',
    order_price FLOAT(6,2) NOT NULL DEFAULT '0',
    order_client INT(10) NOT NULL DEFAULT '0',
...
CREATE TABLE r_getcontent_real(
    ...
    uid INT(10) UNSIGNED NOT NULL,
    time CHAR(30) NOT NULL,
    v_time CHAR(30)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_real_caller(
    ...
    time CHAR(30) NOT NULL,
    v_time CHAR(30)NOT NULL DEFAULT '',
    src_big_cat CHAR(150)NOT NULL DEFAULT '',
    src_chil_cat CHAR(150)NOT NULL DEFAULT '',
    src_key CHAR(150)NOT NULL DEFAULT '',
    v_p_title CHAR(150)NOT NULL DEFAULT '',
    v_herf CHAR(150)NOT NULL DEFAULT '',
    v_position CHAR(150)NOT NULL DEFAULT '',
    v_num INT(10) NOT NULL DEFAULT '0',
    source CHAR(20) NOT NULL DEFAULT '',
    v_follow CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_real_list(
    ...
    time CHAR(30) NOT NULL,
    goods_name CHAR(150)NOT NULL DEFAULT '',
    newly_time CHAR(30)NOT NULL DEFAULT '',
    look_num INT(10) NOT NULL DEFAULT '0',
    v_num INT(10) NOT NULL DEFAULT '0',
    v_p_num INT(10) NOT NULL DEFAULT '0',
    ...
    cate_trade CHAR(60) NOT NULL DEFAULT '',
    cate_shop CHAR(60) NOT NULL DEFAULT '',
    sku CHAR(60)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_real_rate_1(
    ...
    uid INT(10) UNSIGNED NOT NULL,
    time CHAR(30) NOT NULL,
    rank CHAR(150)NOT NULL DEFAULT '',
    src_look CHAR(150)NOT NULL DEFAULT '',
    look_num INT(10) NOT NULL DEFAULT '0',
    look_pro FLOAT(5,2) NOT NULL DEFAULT '0'
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_detail_s(
    ...
    client CHAR(150)NOT NULL DEFAULT '',
    goods_name CHAR(150)NOT NULL DEFAULT '',
    sku_or_spu CHAR(150)NOT NULL DEFAULT '',
    trend CHAR(150)NOT NULL DEFAULT '',
    cate2_id INT(10) NOT NULL DEFAULT '0',
    cate3_id INT(10) NOT NULL DEFAULT '0',
    cate3_name CHAR(150)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_trend(
    ...
    goods_name CHAR(150)NOT NULL DEFAULT '',
    sku_or_spu CHAR(150)NOT NULL DEFAULT '',
    goods_n CHAR(150)NOT NULL DEFAULT '',
    cate2_id INT(10) NOT NULL DEFAULT '0', 
    cate2_name CHAR(150)NOT NULL DEFAULT '',
    cate3_id INT(10) NOT NULL DEFAULT '0',
    cate3_name CHAR(150)NOT NULL DEFAULT '',
    nearly_time CHAR(30)NOT NULL DEFAULT '',
    v_page_num INT(10) NOT NULL DEFAULT '0',
    ...
    page_stip_rate FLOAT(5,2) NOT NULL DEFAULT '0',
    ave_stop_time CHAR(30)NOT NULL DEFAULT '',
    goods_follow_num INT(10) NOT NULL DEFAULT '0',
...
CREATE TABLE r_getcontent_sales_analyse_1(
    ...
    uid INT(10) UNSIGNED NOT NULL,
    time CHAR(30) NOT NULL,
    time_period CHAR(150)NOT NULL DEFAULT '',
    v_num INT(10) NOT NULL DEFAULT '0',
...
CREATE TABLE r_getcontent_order_detail(
    ...
    time CHAR(30) NOT NULL,
    client CHAR(150)NOT NULL DEFAULT '',
    pay_way CHAR(150)NOT NULL DEFAULT '',
    sku CHAR(60)NOT NULL DEFAULT '',
    order_id CHAR(150)NOT NULL DEFAULT '',
    price FLOAT(6,2) NOT NULL DEFAULT '0',
    order_num INT(10) NOT NULL DEFAULT '0',
    ...
    order_price FLOAT(6,2) NOT NULL DEFAULT '0',
    order_total INT(10) NOT NULL DEFAULT '0',
    order_time CHAR(30)NOT NULL DEFAULT '',
    pay_time CHAR(30)NOT NULL DEFAULT '',
    pay_type CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_rate_general(
    ...
    quantum CHAR(150)NOT NULL DEFAULT '',
...
CREATE TABLE r_getcontent_rate_source(
    ...
    time CHAR(30) NOT NULL,
    time_part CHAR(150)NOT NULL DEFAULT '', 
    s_type CHAR(150)NOT NULL DEFAULT '',
    src CHAR(150)NOT NULL DEFAULT '',
    arrive_num INT(10) NOT NULL DEFAULT '0',
    num INT(10) NOT NULL DEFAULT '0',
    num_pro CHAR(150)NOT NULL DEFAULT '',
    trend_analyse CHAR(150)NOT NULL DEFAULT '',
    src_total CHAR(150)NOT NULL DEFAULT '',
    key_analyse CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_resource_strike(
    ...
    time CHAR(30) NOT NULL,
    time_part CHAR(150)NOT NULL DEFAULT '',
    src_ditch CHAR(150)NOT NULL DEFAULT '',
    src_ditch_trend FLOAT(5,2) NOT NULL DEFAULT '0',
    src_url CHAR(150)NOT NULL DEFAULT '',
    order_num INT(10) NOT NULL DEFAULT '0',
    order_price INT(10) NOT NULL DEFAULT '0',
    order_total INT(10) NOT NULL DEFAULT '0',
    detail CHAR(150)NOT NULL DEFAULT ''
)ENGINE=InnoDB;
...
CREATE TABLE r_getcontent_key_analyse_1(
    ...
    time_part CHAR(150)NOT NULL DEFAULT '',
    sku CHAR(60)NOT NULL DEFAULT '',
    goods_page CHAR(150)NOT NULL DEFAULT '',
    t_num INT(10) NOT NULL DEFAULT '0',
    order_num INT(10) NOT NULL DEFAULT '0',
    order_price FLOAT(6,2) NOT NULL DEFAULT '0',
...
/*加用户*/
INSERT INTO r_user(user,password,tell,shop_user,shop_password) VALUES(
    'xiao',
    md5('xiao'),
    '18666015099',
    'xiao',
...
INSERT INTO r_goods(goods_name,price,describes,validity_time) VALUES(
    'goodsname',
    '2099',
    'thi is---------------------',
    '1471335373'
);
INSERT INTO r_record(goods_id,uid,order_time,expire_time) VALUES(
    '1',
    '1',
    '1470335373',
    '1488335373'
);
/*CREATE DATABASE IF NOT EXISTS sbj_api DEFAULT CHARSET utf8 COLLATE utf8_general_ci;*/
/*CREATE DATABASE IF NOT EXISTS yjs DEFAULT CHARSET utf8 COLLATE utf8_general_ci;*/
