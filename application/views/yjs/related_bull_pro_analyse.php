        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="portlet ">
                        <form class="form-inline" action="<?=site_url('yjs/related_bull_pro_analyse');?>" method="get" id="dateform">
                        ...
                        <button type="button" class="btn btn-default navbar-btn" onclick="gtitle1()">地域分布</button>
                        <button type="button" class="btn btn-default navbar-btn" onclick="gtitle2()">时段分布</button>
                        <script>
                            function gtitle1(){
                                            ...
                                            <tbody>
                                                <?php foreach($data['detail']['OrdProNum']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                        ...
                                                        <input type="hidden" value="<?php echo $province[]=$data['detail']['ProvinceName']['value'][$key]?>" name="prosku[]" />    <!-- 省份 --> 
                                                        <input type="hidden" value="<?php echo $ord_goods[]=$data['detail']['OrdProNum']['value'][$key]?>" name="prosku[]" />    <!-- 成交商品数 -->
                                                        <input type="hidden" value="<?php echo $data['detail']['OrdProNumRate']['value'][$key]?>" name="prosku[]" />    <!-- 成交商品数占比 -->
                                                        <input type="hidden" value="<?php echo $ord_peoper[]=$data['detail']['OrdCustNum']['value'][$key]?>" name="prosku[]" />    <!-- 成交人数 -->
                                                        <input type="hidden" value="<?php echo $data['detail']['OrdCustNumRate']['value'][$key]?>" name="prosku[]" />    <!-- 成交人数占比 -->
                                                        <input type="hidden" value="<?php echo $ord_money[]=$data['detail']['OrdAmt']['value'][$key]?>" name="prosku[]" />    <!-- 成交金额 -->
                                                        <input type="hidden" value="<?php echo $data['detail']['OrdAmtRate']['value'][$key]?>" name="prosku[]" />    <!-- 成交金额占比 -->
                                                        
                                                        <td><?php echo $key+1;?></td>                                                
                                                        <td> <?php echo $data['detail']['ProvinceName']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data['detail']['OrdProNum']['value'][$key]?></td>                                                
                                                        <td><?php $pron=$data['detail']['OrdProNumRate']['value'][$key]; echo $pron=ceil($pron*10000)/100?>% </td>
                                                        <td> <?php echo $data['detail']['OrdCustNum']['value'][$key]?></td>                                                
                                                        <td><?php $pron=$data['detail']['OrdCustNumRate']['value'][$key]; echo $pron=ceil($pron*10000)/100?>% </td>
                                                        <td> <?php echo $data['detail']['OrdAmt']['value'][$key]?></td>                                                
                                                        <td><?php $pron=$data['detail']['OrdAmtRate']['value'][$key]; echo $pron=ceil($pron*10000)/100?>% </td>                                                
                        ...
                        <div class="portlet box green" data='cc' id="g2">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>时段分布 </div>
                                        <div class="tools"> </div>
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                            ...
                                            <tbody>
                                                <?php foreach($data1['detail']['TimeID']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                        <input type="hidden" value="<?php echo $key+1;?>" name="key[]" />  <!-- 序号 -->
                                                        <input type="hidden" value="<?php echo $data1['detail']['TimeID']['value'][$key]?>" name="prosku[]" />    <!-- 区间 --> 
                                                        <input type="hidden" value="<?php echo $data1['detail']['UV']['value'][$key]?>" name="prosku[]" />    <!-- UV -->
                                                        <input type="hidden" value="<?php echo $data1['detail']['UVRate']['value'][$key]?>" name="prosku[]" />    <!-- UV占比 -->
                                                        <input type="hidden" value="<?php echo $data1['detail']['OrdCustNum']['value'][$key]?>" name="prosku[]" />    <!-- 成交 -->
                                                        <input type="hidden" value="<?php echo $data1['detail']['OrdCustNumRate']['value'][$key]?>" name="prosku[]" />    <!-- 成交占比 -->
                                                        <input type="hidden" value="<?php echo date("Y-m-d H:m:s",time())?>" name="date[]" />    <!-- 时间 -->
                                                        
                                                        <td><?php echo $key+1;?></td>                                                
                                                        <td> <?php echo $data1['detail']['TimeID']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data1['detail']['UV']['value'][$key]?></td>                                                
                                                        <td><?php $pron=$data1['detail']['UVRate']['value'][$key]; echo $pron=ceil($pron*10000)/100?>% </td>
                                                        <td> <?php echo $data1['detail']['OrdCustNum']['value'][$key]?></td>                                                
                                                        <td><?php $pron=$data1['detail']['OrdCustNumRate']['value'][$key]; echo $pron=ceil($pron*10000)/100?>% </td>
                                                        <td> <?php echo date("Y-m-d H:m:s",time())?></td>                                                
                                                        <td><input type="button" value="点击查看" name="chkk[]" onclick="shop_list(this)"></td>                                                                                               
                                                    </tr>
                                                <?php }?>
                        ...
                        <script>
                            ...
                            function shop_list(obj){
                                ...
                                Ajax().post("<?php echo site_url('yjs/related_bull_pro_analyse')?>",{prosku:prosku,date:date_p,method:method_p},function(data){
