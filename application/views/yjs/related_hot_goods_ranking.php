        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="portlet ">
                        <form class="form-inline" action="<?=site_url('yjs/related_hot_goods_ranking');?>" method="get" id="dateform">
                        ...
                        <script>
                            ...
                            function shop_list(obj){
                                ...
                                Ajax().post("<?php echo site_url('yjs/related_hot_goods_ranking_1')?>",{prosku:prosku,date:date_p,method:method_p},function(data){
