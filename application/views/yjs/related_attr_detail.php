        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="portlet ">
                        <form class="form-inline" action="<?=site_url('yjs/related_attr_detail');?>" method="get" id="dateform">
                          ...
                          <select class="form-control" name="attr" id="attrid" >
                          ...
                          <script>
                              ...
                              getCate(selected_cate2,'cate3','三级类目',getCateIndex(window.cate3,selected_cate3));
                                ...
                                var rebrand="<?php echo $attr?>";
                                showattrs();
                                if(rebrand!=''){
                                  showattrs('',getCateIndex(window.attrid,rebrand));
                                }
                          </script>
                        </form>
                        ...
                        <div class="portlet box green" data='cc' id="g1">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>属性分析 </div>
                                        <div class="tools"> </div>
                                    ...
                                    <div class="portlet-body">
                                            ...
                                            <tbody>
                                                <?php foreach($data['Attr_level2_name']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                        ...
                                                        <input type="hidden" value="<?php echo $data['attrname'][$key];?>" name="attrname[]" />    <!-- 属性名称 --> 
                                                        ...
                                                        <input type="hidden" value="<?php echo $data['ShopRankUrl']['value'][$key]?>" name="prosku[]" />    <!-- 店铺排名 -->
                                                        <input type="hidden" value="<?php echo $data['ProdRankUrl']['value'][$key]?>" name="prosku[]" />    <!-- 商品排名 -->
                                                        ...
                                                        <td> <?php echo $data['ShopRankUrl']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data['ProdRankUrl']['value'][$key]?></td>                                                
                                                        <td> <?php echo date("Y-m-d H:m:s",time())?></td>                                                
                                                        <td><input type="button" value="点击查看" name="chk[]" onclick="shop_list(this)"></td>  <!-- 属性详情 -->                                                                                               
                                                    </tr>
                                                <?php }?>
                                            </tbody>
                                        </table>
                                        ...
                                        <script>
                                            ...
                                            function shop_list(obj){
                                                ...
                                                var items=new Array('num','attr','strike_index','strike_user_index','shop_num','goods_num','shop_ranking','goods_ranking','show_date','attr_detail');//传值的键
                                                ...
                                                var attr_1=values['attr'].match(/Attr_level2_code=(.*?)&/);//正则匹配出attr3id
                                                var attr_1=attr_1[1];
                                                var attr2=[
                                                    '<?php echo $this->input->get('attr')?>',
                                                    attr_1,
                                                ...
                                                window.location.href="<?php echo site_url('yjs/related_attr_detail_1')?>?"+url;
                                            }
                                        </script>
                                    </div>
                        </div>
