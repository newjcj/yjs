                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item ">
                                    <a href="<?php echo site_url('yjs/rate1');?>" class="nav-link ">
                        ...
                        <li class="nav-item start active open ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item actiove open ">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="ui_colors.php" class="nav-link ">
                                        <span class="title">app端/M端搜索类目查询</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="ui_colors.php" class="nav-link ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item ">
                                            <a href="ui_page_progress_style_1.php" class="nav-link ">热销商家排行</a>
                                        </li>
                                        <li class="nav-item ">
                                            <a href="ui_page_progress_style_2.php" class="nav-link ">热销商品排行</a>
                                        </li>
                                        <li class="nav-item ">
                                            <a href="ui_page_progress_style_2.php" class="nav-link ">飙升商品排行</a>
                                        </li>
                                        <li class="nav-item ">
                                            <a href="ui_page_progress_style_2.php" class="nav-link ">买家购买分析</a>
                                        </li>
                                        <li class="nav-item ">
                                            <a href="ui_page_progress_style_2.php" class="nav-link ">买家特征分析</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item ">
