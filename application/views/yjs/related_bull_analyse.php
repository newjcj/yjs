        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="portlet ">
                        <form class="form-inline" action="<?=site_url('yjs/related_bull_analyse');?>" method="get" id="dateform">
                        ...
                        <button type="button" class="btn btn-default navbar-btn" onclick="gtitle1()">商品成交单价占比</button>
                        <button type="button" class="btn btn-default navbar-btn" onclick="gtitle2()">客单价占比</button>
                        <button type="button" class="btn btn-default navbar-btn" onclick="gtitle3()">买家购买频次</button>
                        <script>
                            function gtitle1(){
                            ...
                            function gtitle3(){
                                ...
                                window.main1.style.display="none";
                                window.main2.style.display="none";
                                window.main3.style.display="block";
                            }
                        ...
                        <div class="portlet box green" data='cc' id="g1">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tbody>
                                                <?php foreach($data['proNumAnlys']['OrdProNum']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                       
                                                        <input type="hidden" value="<?php echo $key+1;?>" name="key[]" />  <!--  -->                                              
                                                        <input type="hidden" value="<?php echo $reg_echar[]=$data['proNumAnlys']['RegionName']['value'][$key]?>" name="prosku[]" />    <!--  -->    
                                                        <input type="hidden" value="<?php echo $num_echar[]=$value?> " name="price[]" />    <!--  -->                            
                                                        <input type="hidden" value="<?php echo $data['proNumAnlys']['OrdProNumPERC']['value'][$key]?>" name="bargainindex[]" />    <!--  -->                            
                                                        
                                                        <td><?php echo $key+1;?></td>                                                
                                                        <td> <?php echo $data['proNumAnlys']['RegionName']['value'][$key]?></td>                                                
                                                        <td> <?php echo $value?></td>                                                
                                                        <td><?php $pron=$data['proNumAnlys']['OrdProNumPERC']['value'][$key]; echo $pron=ceil($pron*10000)/100?>% </td>                                                
                                    ...
                                    series : [
                                        {
                                            ...
                                            data:[
                                                <?php 
                                                    $str='';
                                                    foreach($reg_echar as $k=>$v){
                                                        $str.='{value:'.$num_echar[$k].', name:"区间为:'.strval($v).'"},';
                                                    }
                                                    echo $str;
                                                ?>
                        ...
                        <div class="portlet box green" data='cc' id="g2">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                            ...
                                            <tbody>
                                                <?php foreach($data['custNumAnlys']['RegionName']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                       
                                                        <input type="hidden" value="<?php echo $key+1;?>" name="key[]" />  <!--  -->                                              
                                                        <input type="hidden" value="<?php echo $reg_echar_1[]=$value?>" name="prosku[]" />    <!--  -->    
                                                        <input type="hidden" value="<?php echo $num_echar_1[]=$data['custNumAnlys']['OrdCustNum']['value'][$key]?> " name="price[]" />    <!--  -->                            
                                                        <input type="hidden" value="<?php echo $data['custNumAnlys']['OrdCustNumPERC']['value'][$key]?>" name="bargainindex[]" />    <!--  -->                            
                                                        
                                                        <td><?php echo $key+1;?></td>                                                
                                                        <td> <?php echo $value?></td>                                                
                                                        <td> <?php echo $data['custNumAnlys']['OrdCustNum']['value'][$key]?></td>                                                
                                                        <td><?php $pron=$data['custNumAnlys']['OrdCustNumPERC']['value'][$key]; echo $pron=ceil($pron*10000)/100?>% </td>                                                
                                                        <td> <?php echo date("Y-m-d H:m:s",time())?></td>                                                
                                                        <td><input type="button" value="点击查看" name="chkk[]" onclick="shop_list(this)"></td>                                                                                               
                                                    </tr>
                                                <?php }?>
                                    ...
                                    series : [
                                        {
                                            ...
                                            data:[
                                                <?php 
                                                    $str='';
                                                    foreach($reg_echar_1 as $k=>$v){
                                                        $str.='{value:'.$num_echar_1[$k].', name:"区间为:'.strval($v).'"},';
                                                    }
                                                    echo $str;
                                                ?>
                        ...
                        <div class="portlet box green" data='cc' id="g3">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                            ...
                                            <tbody>
                                                <?php foreach($data['freq']['DealCustNum']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                       
                                                        <input type="hidden" value="<?php echo $key+1;?>" name="key[]" />  <!--  -->                                              
                                                        <input type="hidden" value="<?php echo $reg_echar_2[]=$data['freq']['DealFreq']['value'][$key]?>" name="prosku[]" />    <!--  -->    
                                                        <input type="hidden" value="<?php echo $num_echar_2[]=$value?> " name="price[]" />    <!--  -->                            
                                                        <input type="hidden" value="<?php echo $data['freq']['DealFreq']['value'][$key]?>" name="bargainindex[]" />    <!--  -->                            
                                                        
                                                        <td><?php echo $key+1;?></td>                                                
                                                        <td> <?php echo $data['freq']['DealFreq']['value'][$key]?></td>                                                
                                                        <td> <?php echo $value?></td>                                                
                                                        <td><?php $pron=$data['freq']['DealCustNumPERC']['value'][$key]; echo $pron=ceil($pron*10000)/100?>% </td>                                                
                                                        <td> <?php echo date("Y-m-d H:m:s",time())?></td>                                                
                                                        <td><input type="button" value="点击查看" name="chkk[]" onclick="shop_list(this)"></td>                                                                                               
                                                    </tr>
                                                <?php }?>
                        ...
                        <!-- 为 ECharts 准备一个具备大小（宽高）的Dom -->
                        <div id="main3" style="width:88%;height:400px;"></div>
                        <script type="text/javascript">
                                    ...
                                    series : [
                                        {
                                            ...
                                            data:[
                                                <?php 
                                                    $str='';
                                                    foreach($reg_echar_2 as $k=>$v){
                                                        $str.='{value:'.$num_echar_2[$k].', name:"区间为:'.strval($v).'"},';
                                                    }
                                                    echo $str;
                                                ?>
