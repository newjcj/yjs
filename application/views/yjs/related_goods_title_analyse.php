        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="portlet ">
                        <form class="form-inline" action="<?=site_url('yjs/related_goods_title_analyse');?>" method="get" id="dateform">
                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading">商品标题</div>
                            <div class="panel-body">
                                <?php echo $data2['name']?>
                            </div>
                        </div>
                        <div class="panel panel-success">
                            <div class="panel-heading">匹配关键词</div>
                            <div class="panel-body">
                                <?php 
                                    $str='';
                                            ...
                                            <tbody>
                                                <?php foreach($data1['detail']['HotWords']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                        ...
                                                        <input type="hidden" value="<?php echo $data1['detail']['HotWords']['value'][$key];?>" />    <!-- 匹配热词 --> 
                                                        <input type="hidden" value="<?php echo $data1['detail']['HotWordsNoLink']['value'][$key];?>" name="keys[]" />    <!-- 匹配热词 --> 
                                                        <input type="hidden" value="<?php echo $data1['detail']['SearchPopularity']['value'][$key]?>"  />    <!-- 搜索人气 --> 
                                                        <input type="hidden" value="<?php echo $data1['detail']['SearchIndex']['value'][$key]?>"  />    <!-- 搜索指数 --> 
                                                        <input type="hidden" value="<?php echo $data1['detail']['ClickIndex']['value'][$key]?>"  />    <!-- 点击指数 -->
                                                        <input type="hidden" value="<?php echo $data1['detail']['ClickRate']['value'][$key]?>"  />    <!-- 点击率 -->
                                                        <input type="hidden" value="<?php echo $data1['detail']['SaleIndex']['value'][$key]?>"/>    <!-- 成交指数 -->
                                                        <input type="hidden" value="<?php echo $data1['detail']['ConvertRate']['value'][$key]?>" />    <!-- 转化率 -->
                                                        <input type="hidden" value="<?php echo $data1['detail']['Level3Name']['value'][$key]?>" name="cateName[]" />    <!-- 三级类目名字 -->
                                                        ...
                                                        <td> <?php echo $data1['detail']['SearchPopularity']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data1['detail']['SearchIndex']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data1['detail']['ClickIndex']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data1['detail']['ClickRate']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data1['detail']['SaleIndex']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data1['detail']['ConvertRate']['value'][$key]?></td>                                                
                                                        <td> </td>                                                
                                                        <td> <input type="button" value="查看详情" name="show[]" onclick="showChar(this)"></td>                                                
