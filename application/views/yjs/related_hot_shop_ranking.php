        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="portlet ">
                        <form class="form-inline" action="<?=site_url('yjs/related_hot_shop_ranking');?>" method="get" id="dateform">
                          ...
                          <select class="form-control" name="method">
                              ...
                              <option value="6">M端</option>
                              <option value="7">微信</option>
                              <option value="8">手Q</option>
                          </select>
                        ...
                        <button type="button" class="btn btn-default navbar-btn" onclick="gtitle1()">热卖商家TOP榜单</button>
                        <button type="button" class="btn btn-default navbar-btn" onclick="gtitle2()">热卖飙升TOP榜单</button>
                        <button type="button" class="btn btn-default navbar-btn" onclick="gtitle3()">热卖人气TOP榜单</button>
                        <script>
                            function gtitle1(){
                        ...
                        <div class="portlet box green" data='cc' id="g1">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tbody>
                                                <?php foreach($data[0]['ShopId']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                        <input type="hidden" value="<?php echo $key+1;?>" name="DateTime[]" />  <!--  日期-->                                              
                                                        <input type="hidden" value="<?php echo $data[0]['ShopName']['value'][$key]?>" name="SearchClickIndex[]" />    <!--  商家名称-->    
                                                        <input type="hidden" value="<?php echo $data[0]['ShopId']['value'][$key]?>" name="shopid[]" />    <!--  商家编号-->                            
                                                        <input type="hidden" value="<?php echo $data[0]['SalesIndex']['value'][$key]?>" name="Price[]" />    <!--  热卖指数-->                            
                                                        <input type="hidden" value="<?php echo $data[0]['PopularityIndex']['value'][$key]?>" name="FollowPopularity[]" />    <!--  人气指数-->    
                                                        <input type="hidden" value="<?php echo date("Y-m-d H:m:s",time())?>" name="time[]" />      <!--  时期-->                     
                                                        <input type="hidden" value="" name="ProductIndex[]" />    <!--  热卖商品-->                            
                                                        
                                                        <td><?php echo $key+1;?></td>                                                
                                                        <td> <?php echo $data[0]['ShopName']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data[0]['ShopId']['value'][$key]?></td>                                                
                                                        <td><?php echo $data[0]['SalesIndex']['value'][$key]?> </td>                                                
                                                        <td> <?php echo $data[0]['PopularityIndex']['value'][$key]?></td>                                                
                        ...
                        <div class="portlet box green" id="g2" style="display:none;">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>热卖飙升TOP榜单 </div>
                                        <div class="tools"> </div>
                                    </div>
                                    <div class="portlet-body">
                                        <form action="<?=site_url('datainto/related_hot_shop_ranking')?>" method="post" id="formdata">
                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                            ...
                                            <tbody>
                                                <?php foreach($data[1]['ShopId']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                        <input type="hidden" value="<?php echo $key+1;?>" name="DateTime[]" />  <!--  日期-->                                              
                                                        <input type="hidden" value="<?php echo $data[1]['ShopName']['value'][$key]?>" name="SearchClickIndex[]" />    <!--  商家名称-->    
                                                        <input type="hidden" value="<?php echo $data[1]['ShopId']['value'][$key]?>" name="shopid[]" />    <!--  商家编号-->                            
                                                        <input type="hidden" value="<?php echo $data[1]['SalesSurge']['value'][$key]?>" name="FollowPopularity[]" />    <!--  热卖飙升幅度-->    
                                                        <input type="hidden" value="<?php echo date("Y-m-d H:m:s",time())?>" name="time[]" />      <!--  时期-->                     
                                                        <input type="hidden" value="" name="ProductIndex[]" />    <!--  热卖商品-->                            
                                                        
                                                        <td><?php echo $key+1;?></td>                                                
                                                        <td> <?php echo $data[1]['ShopName']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data[1]['ShopId']['value'][$key]?></td>                                                
                                                        <td><?php echo $data[1]['SalesSurge']['value'][$key]?> </td>                                                
                                                        <td> <?php echo date("Y-m-d H:m:s",time())?></td>                                                
                                                        <td><input type="button" value="点击查看" name="chkk[]" onclick="shop_list(this)"></td>                                                                                               
                                                    </tr>
                                                <?php }?>
                        ...
                        <div class="portlet box green" id="g3" style="display:none;">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>热卖人气TOP榜单 </div>
                                        <div class="tools"> </div>
                                    </div>
                                    <div class="portlet-body">
                                        <form action="<?=site_url('datainto/related_hot_shop_ranking')?>" method="post" id="formdata">
                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                            ...
                                            <tbody>
                                                <?php foreach($data[2]['ShopId']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                        <input type="hidden" value="<?php echo $key+1;?>" name="DateTime[]" />  <!--  日期-->                                              
                                                        <input type="hidden" value="<?php echo $data[2]['ShopName']['value'][$key]?>" name="SearchClickIndex[]" />    <!--  商家名称-->    
                                                        <input type="hidden" value="<?php echo $data[2]['ShopId']['value'][$key]?>" name="shopid[]" />    <!--  商家编号-->                            
                                                        <input type="hidden" value="<?php echo $data[2]['NewPopularity']['value'][$key]?>" name="Price[]" />    <!--  热卖指数-->                            
                                                        <input type="hidden" value="<?php echo date("Y-m-d H:m:s",time())?>" name="time[]" />      <!--  时期-->                     
                                                        <input type="hidden" value="" name="ProductIndex[]" />    <!--  热卖商品-->                            
                                                        
                                                        <td><?php echo $key+1;?></td>                                                
                                                        <td> <?php echo $data[2]['ShopName']['value'][$key]?></td>                                                
                                                        <td> <?php echo $data[2]['ShopId']['value'][$key]?></td>                                                
                                                        <td><?php echo $data[2]['NewPopularity']['value'][$key]?> </td>                                                
                                                        <td> <?php echo date("Y-m-d H:m:s",time())?></td>                                                
                                                        <td><input type="button" value="点击查看" name="chkk[]" onclick="shop_list(this)"></td>                                                                                               
                                                    </tr>
                                                <?php }?>
