        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="portlet ">
                        <form class="form-inline" action="<?=site_url('yjs/related_trade_hot_word');?>" method="get" id="dateform">
                          ...
                          <div class="form-group">
                            <label class="sr-only" for="exampleInputEmail3"></label>
                            <input type="text" class="form-control" id="exampleInputEmail3" name="sku" value="<?php echo $this->input->get('sku')?>" placeholder="请输入关键词">
                          </div>
                        ...
                        <div class="portlet box green" data='cc' id="g1">
                                    ...
                                    <div class="portlet-body">
                                        <form action="<?=site_url('datainto/related_trade_hot_word')?>" method="post" id="formdata">
                                            ...
                                            <tbody>
                                                <?php foreach($data['detail']['HotWords']['value'] as $key=>$value){?>
                                                    <tr id="tr_db">
                                                        ...
                                                        <input type="hidden" value="<?php echo $data['detail']['Level3Name']['value'][$key];?>" name="keys[]" />    <!-- 三级类目 --> 
                                                        ...
                                                        <input type="hidden" value="<?php echo $data['detail']['ClickRate']['value'][$key]?>"  />    <!-- 点击率 -->
                                                        <input type="hidden" value="<?php echo $data['detail']['SaleIndex']['value'][$key]?>"/>    <!-- 成交指数 -->
                                                        ...
                                                        <td> <?php echo $data['detail']['Level3Name']['value'][$key]?></td>                                                
