        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="portlet ">
                        <form class="form-inline" action="<?=site_url('yjs/related_cate_w');?>" method="get" id="dateform">
                          <div class="form-group">
                            <label class="sr-only" for="exampleInputEmail3"></label>
                            <input type="text" class="form-control" id="exampleInputEmail3" name="key" value="<?php echo $this->input->get('key')?>" placeholder="输入关键词">
                          </div>
                          <div class="form-group">
                            <label class="sr-only" for="exampleInputEmail3"></label>
                    ...
                    <div class="portlet box green">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <?php foreach($data as $key=>$value){?>
                                                <?php foreach($value['sku'] as $k=>$v){?>
                                                    <tr id="tr_db">
                                                        ...
                                                        <td onclick="dodata1('<?php echo $key*30+$k?>')"><input type="button" value="保存" name="r_getcontent_w[]" onclick="r_getcontent_w(this)"></td>     <!-- 测试-->
                                                    </tr>
                                                <?php }?>
                                            <?php }?>
                                        </tbody>
                                    ...
                                    <?php echo A_D(array('ranking','page','title','sku','price','assess','time','who'),'datainto/r_getcontent_w','r_getcontent_w','r_getcontent_w[]')?>
                                </div>
                            </div>
