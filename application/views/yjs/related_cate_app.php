        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="portlet ">
                        <form class="form-inline" action="<?=site_url('yjs/related_cate_app');?>" method="get" id="dateform">
                          <div class="form-group">
                            <label class="sr-only" for="exampleInputEmail3"></label>
                            <input type="text" class="form-control" id="exampleInputEmail3" name="key" value="<?php echo $this->input->get('key')?>" placeholder="输入类目地址">
                          </div>
                          <div class="form-group">
                            <label class="sr-only" for="exampleInputEmail3"></label>
                    ...
                    <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>APP端/M端搜索排名监测
 </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                            ...
                                            <?php foreach($data as $key=>$value){?>
                                                <?php foreach($value['sku'] as $k=>$v){?>
                                                    <tr id="tr_db">
                                                        ...
                                                        <input type="hidden" value="<?php echo $value['name'][$k]?>" name="goodsname[]" />   <!-- 标题-->                                             
                                                        ...
                                                        <td><?php echo $value['name'][$k]?></td>   <!-- 标题-->                                             
                                    ...
                                    <script>
                                        function dodata(obj){
                                            ...
                                            Ajax().post('<?php echo site_url("datainto/r_getcontent_a")?>',{num:nums,goodsname:goodsname_d.value,price:price_d.value,sku:sku_d.value,assess:assess_d.value,who:who_d.value,page:page_d.value,time:time_d.value,ranking:ranking_d.value},function(data){
                                                    alert(data);
