                                        ...
                                        <tbody>
                                            <?php if($data!==''){foreach($data as $item){?>
                                                <tr>
                                                    ...
                                                    <td><? echo $item['describes']?></td>
                                                    <td><?php echo G_TIME(($item['validity_time']+$item['order_time'])-time());?></td><!--剩余时间-->
                                                    <td><? echo date("Y-m-d H:h:s",$item['expire_time'])?></td><!--到期时间-->
                                                </tr>
                                            <?php }}?>
                                        </tbody>
                                    </table>
