                        ...
                        <div class="col-md-12">
                           <!--  <div class="note note-success">
                                    ...
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        <thead class="flip-content">
                                            <tr>
                                                ...
                                                <th class="numeric"> 可使用期限 </th>
                                                <th class="numeric"> 购买 </th>
                                                <th class="numeric"> 使用 </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach($data as $item){?>
                                                <tr>
                                                    <td><?=$item['goods_id'];?></td>
                                                    <td><a href="<?=base_url();?>pay/index11.php" target="_blank"><?=$item['goods_name'];?></a></td>
                                                    <td><a href="#" target="_blank"><?=$item['price'];?></a></td>
                                                    <td><a href="#" target="_blank"><?=$item['describes'];?></a></td>
                                                    <td><? echo G_TIME($item['validity_time'])?></td><!--有效时间-->
                                                    <td><a href="<?php echo base_url()?>/pay/index.php?goods_name=<?php echo $item['goods_name']?>&goods_id=<?php echo $item['goods_id']?>&describes=<?php echo $item['describes']?>&price=<?php echo $item['price']?>" target="_blank"><button type="button" class="btn btn-default">购买</button></a></td>
                                                    <td><button type="button" class="btn btn-default goods" id="use_goods">使用</button></td>
                                                </tr>
                                            <?php }?>
                                        </tbody>
                                    </table>
                            ...
                            <script>
                                ...
                                $(function(){
                                    $('.goods,#into_data').click(function(){
                                        if(thor.length>0){
