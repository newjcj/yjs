                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" class="form-control" id="exampleInputPassword1" name="repassword" placeholder="确认密码" value=""/>
                                                </div>
                                                <label style="margin-left:40px;margin-top:8px;"><?php echo form_error('repassword','<span style="color:red">','</span>')?></label>
                                            </div>
                                            <div class="form-group">
                                                <label>邮箱地址:</label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="email" placeholder="邮箱地址" value="<?php echo $ulist['email']?>"/>
                                                    
                                                </div>
                                                <label style="margin-left:40px;margin-top:8px;"><?php echo form_error('email','<span style="color:red">','</span>')?></label>
                                            </div>
                                            <div class="form-group">
                                                <label>手机号：</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <i class="fa fa-mobile-phone font-red"></i>
                                                    </span>
                                                    <input type="text" class="form-control" name="tell" placeholder="手机号" value="<?php echo $ulist['tell']?>"/>
                                                    </div>
                                                    <label style="margin-left:40px;margin-top:8px;"><?php echo form_error('tell','<span style="color:red">','</span>')?></label>
                                            </div>
                                            <div class="form-group">
                                                <label>qq：</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <i class="fa fa-qq font-red"></i>
                                                    </span>
                                                    <input type="text" class="form-control" name="qq" placeholder="qq" value="<?php echo $ulist['qq']?>"/>
                                                </div>
                                                <label style="margin-left:40px;margin-top:8px;"><?php echo form_error('qq','<span style="color:red">','</span>')?></label>
                                            </div>
                                        </div>
