...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <?php $this->load->view('public/view_user')?><!--加载右上user-->        <!-- END HEADER -->
                                        ...
                                        <tbody>
                                            <?php foreach($data as $item){?>
                                                <tr>
                                                    <td><? echo $item['id']?></td>
                                                    <td><? echo $item['uid']?></td>
                                                    <td><? echo $item['payid']?></td>
                                                    <td><? echo date("Y-m-d H:h:s",$item['time'])?></td>
                                                </tr>
                                            <?php }?>
                                        </tbody>
                                    </table>
