        ...
        <div class="page-container">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  staret active open">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="<?php echo site_url('datasearch/r_getcontent_c');?>" class="nav-link ">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <?php $tit=array('pc端搜索排名监测','APP端/M端搜索排名监测','微信端排名监测');
                          $searchurl=array('','','');;
?>
                    <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i><?php echo $tit[$key]?></div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    <form action="<?=site_url('datainto/related_cate_app')?>" method="post" id="formdata">
                                    <table class="table table-striped table-bordered table-hover" id="sample_<?=$key+1?>">
                                        <thead>
                                            <tr>
                                                <th> 序号</th>
                                                <th> 排名</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($value as $k=>$v){?>
                                                 <tr>
                                                    <td><?php echo $v['id']?></td><!--序号-->
                                                    <td><?php echo $v['ranking']?></td><!--排名-->
                                                    <td><?php echo $v['page']?></td><!--页数-->
                                                    <td><?php echo $v['name']?></td><!--标题-->
                                                    <td><?php echo $v['sku']?></td><!--SKU-->
                                                    <td><?php echo $v['price']?></td><!--价格-->
                                                    <td><?php echo $v['assess']?></td><!--评价人数-->
                                                    <td><?php echo $v['time']?></td><!--时间-->
                                                    <td><?php echo $v['who']?></td><!--类型-->
                                                </tr>
                                            <?php }?>
                                        </tbody>
                                    </table>
