        ...
        <div class="content">
            ...
            <form class="login-form" action="<?php echo site_url('login/check');?>" method="post" name="loginfrm">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" id='user' type="text" autocomplete="off" value="" placeholder="用户名" name="user" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">密码</label>
                    <input class="form-control form-control-solid placeholder-no-fix" id='password' type="password" autocomplete="off"  value="" placeholder="密码" name="password" /> </div>
                <div class="form-group">
                    ...
                    <img style="position:relative;top:-32px;left:180px;;" id="vimg" onclick="chimg()" src=""/>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <label class="rememberme check mt-checkbox mt-checkbox-outline">
                        <input type="checkbox" name="remember" value="1" onchange="save()" />记住用户名
                        <span></span>
                    </label>
...
<![endif]-->
        ...
        <script src="<?=base_url();?>tpl/assets/global/plugins/js.cookie.min11.js" type="text/javascript"></script>
        ...
        <script src="<?php echo base_url()?>public/js/jq-cookie.js"></script>
