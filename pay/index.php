	...
	<div class="header">
		...
		<div class="container">
			<div class="nav">
				...
				<a href="http://open.alipay.com/platform/home.htm" class="open" target="_blank"></a>
				<ul class="navbar">
					<li><a href="https://doc.open.alipay.com/doc2/detail?treeId=62&articleId=103566&docType=1" target="_blank"></a></li>
					<li><a href="https://cschannel.alipay.com/portal.htm?sourceId=213" target="_blank"></a></li>
				</ul>
			</div>
		</div>
	...
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
			<div class="element" style="margin-top:60px;">
				<div class="legend">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;支付信息</div>
			</div>
			<input type="hidden" name="WIDout_trade_no" id="out_trade_no">
			<div class="element">
				<div class="etitle">商品名称:</div>
				<input type="hidden" readOnly="readOnly" name="WIDsubject" value="<?php echo $_GET['goods_id']?>">
				<div class="einput"><input type="text" readOnly="readOnly" name="" value="<?php echo $_GET['goods_name']?>"></div>
				<br>
				<div class="mark" style="display:none">注意：产品名称(subject)，必填(建议中文，英文，数字，不能含有特殊字符)</div>
			</div>
			<div class="element">
				<div class="etitle">付款金额:</div>
                <div class="einput"><input type="text" readOnly="readOnly" name="WIDtotal_fee" value="<?php echo $_GET['price']?>"></div>
				<br>
				<div class="mark" style="display:none">注意：付款金额(total_fee)，必填(格式如：1.00,请精确到分)</div>
			</div>
			<div class="element">
				<div class="etitle">商品描述:</div>
				<div class="einput"><input type="text" readOnly="readOnly" name="WIDbody" value="<?php echo $_GET['describes']?>"></div>
				<br>
				<div class="mark" style="visibility:hidden">注意：商品描述(body)，选填(建议中文，英文，数字，不能含有特殊字符)</div>
			</div>
			<div class="element">
...
<script>
	...
	var showqrs = document.getElementById("showqrs");
	 ...
	 out_trade_no.value = 'yjs'+Math.floor(Math.random()*1000)+new Date().format("yyyyMMddhhmmss");
</script>
